...
<body id="headerId" ng-app="renserApp" ng-controller="loginCtrl"
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		...
		<div class="row" style="padding: 5px; margin-top: 6%;">

			<div class="panel panel-default" style="border-color: #18BC9C;">
				<div class="panel-heading" style="background-color: #18BC9C;">
					<a style="color: white" href="#">Corporate Login: <span ng-bind="companyInfo.name"></span></a>
				</div>
				<div class="panel-body">
 <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="{{companyInfo.profilePic}}" data-toggle="modal" data-target="#myModalprofilePic " 
					...
					<div id="loginbox"
						...
						<div class="form-login">
							...
							<form name="userloginForm" method="post"
								...
								<div style="margin-bottom: 25px" class="input-group ng-hide">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-user"></i></span> <span
										id="companyName" style="background-color: #eee;" name="companyName"
										ng-model="loginForm.companyName" class="form-control"
										placeholder="Login id" ng-bind="loginForm.companyName"></span>
								</div>
						...
						onClick="$('#loginbox').hide(); $('#forgotpassword').show();">Change password</a>
						

										<button
											ng-disabled="userloginForm.$invalid"
											ng-click="login('<?php echo $configs->userTypeCompanyUser; ?>')" title="Login"
						...
						<div class="form-login">
							<div id="loginFormMsg" class="ng-hide"></div>
							<form name="userForgotPassForm" method="post"
								enctype="multipart/form-data">
								...
								<div style="margin-bottom: 25px" class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-lock"></i></span> <input
										type="password" class="form-control" id="userConfPass"
										name="userConfPass" ng-model="loginForm.confPassword"
								...
								<div class="wrapper">
									<span class="group-btn loginBtn">
										...
										<button
											ng-disabled="userForgotPassForm.$invalid"
											ng-click="modifyPassCorporateUser()" title="Modify Password"
											class="btn btn-primary btn-md">
											Modify password<i class="fa fa-sign-in"></i>
										</button>
										<a href="" class="btn btn-default"
						onClick="$('#loginbox').show(); $('#forgotpassword').hide();">Close</a>
									</span>
								</div>
							</form>
						</div>

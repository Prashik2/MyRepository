		...
		<div class="container">
			...
			<div>
				 <ul class="nav navbar-nav navbar-right">
	       			 <li>
	       			 	<a  href="#" ng-click="logout();close_window();">
		...
		<div class="row content">
			...
			<div class="col-sm-2 sidenav round-corner">
				...
				<ul class="nav nav-pills nav-stacked vMenu">
					...
					<li id="vMenuAddUserId" class="text-left" ng-click="addActiveClass('vMenuAddUserId');">
						<a href="#" class="glyphicon glyphicon-list-alt" ng-click="changeScreen('adduser');getEmployeeList();" title="Employee">&nbsp;Employee</a>
					</li>
			...
			<div ng-show="screenVisible['adduser'].value">
					<div ng-include="'addEmployee.php'"></div>
				</div>
